package com.nctapps.app.data.local

import android.content.Context
import android.content.SharedPreferences
import android.renderscript.ScriptGroup
import com.nctapps.app.data.model.ActionState
import com.nctapps.app.data.model.AuthUser
import com.nctapps.app.util.getObject
import com.nctapps.app.util.putObject
...
class AuthPref(val context: Context) {
    ...
    suspend fun login(email: String, password: String): ActionState<AuthUser> {
        ...
        if (user == null) {
            ...
            return ActionState(message = "Email dan password tidak boleh", isSuccess = false)
